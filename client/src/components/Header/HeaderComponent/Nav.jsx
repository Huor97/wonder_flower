    ...
    <>
      <header className="flex justify-between items-center">
        <div className="flex justify-between items-center">
          {' '}
          <Link to="/">
            <img src={Logo} alt="Logo" className="h-16 p-1 pl-14" />
          </Link>
          <Link to="/">
            <h1 className="text-xl text-green-900 body-font font-Yeseva">
              <RandomizeText text="Wonderflower" />
            </h1>
          </Link>
        </div>
        ...
        <div>
          <ul className="flex">
            <li>
              ...
              {loggin === true ? (
                <BasketButton loggin={loggin} setLoggin={setLoggin} />
              ) : (
                ''
              )}
            </li>
            ...
            <li>
              ...
              {loggin === true ? (
                <AdminButton loggin={loggin} setLoggin={setLoggin} />
              ) : (
                ''
              )}
            </li>
            ...
            <li>
              ...
              {loggin === true ? (
                <LogoutButton loggin={loggin} setLoggin={setLoggin} />
              ) : (
                <LoginButton />
              )}
            </li>
